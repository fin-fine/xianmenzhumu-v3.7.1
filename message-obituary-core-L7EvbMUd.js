...
${e.name} 遗言
云澜历 ${t.year}年 ${t.month}月`}};function d(e,o,t,n="default"){const s=$(o);return n==="friend"&&(e.fatherName||e.motherName||e.generation||e.parent||e.parentId||s.some(i=>i.id===e.id))&&(n="child"),(l[n]||l.default)(e,o,t)}export{d as generateObituaryContent};
